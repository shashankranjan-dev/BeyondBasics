      ...
      <div class="max-w-screen-2xl mx-auto p-5 sm:p-10 md:p-8">
        <div class="border-b mb-5 flex justify-between text-sm">
          ...
          <div className=" flex flex-wrap sm:justify-end mr-2 justify-center gap-4 z-50">
            <button className="btn btn-primary rounded-full hover:bg-blue-600 text-black text-xs font-semibold py-2 px-2 testimonial-swiper-button-prev">
              <svg
            ...
            <button className=" btn btn-primary rounded-full hover:bg-blue-600 text-black text-xs font-semibold py-2 px-2 testimonial-swiper-button-next">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <div class="rounded overflow-hidden shadow-lg flex flex-col">
              <div class="relative">
                <a href="!#">
                  <img
                    class="w-full"
                    src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8ZWR1Y2F0aW9uJTIwdGVjaG5vbG9neXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"

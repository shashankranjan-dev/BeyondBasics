  ...
  return (
    <div>
      <div class="bg-white py-6 sm:py-8 lg:py-2 ">
        <div class="mx-auto max-w-screen-xl px-4 md:px-16 ">
          <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 lg:gap-56 px-2  ">
            <div>
              <div class="rounded-lg border p-4 sm:w-96 shadow-md shadow-blue-300">
            ...
            <div class="lg:col-span-2">
              ...
              <div class="border-t pt-6">
                <a
                  href="#"
                  class="flex items-center gap-0.5 font-semibold text-indigo-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600"
                >
                  Read all reviews
                </a>
              </div>
